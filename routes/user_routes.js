...
router.get("/",async function(req,res){
    ...
    var obj={"company_info":company_info[0],"slides":slides,"blogs":blog};
...
router.get("/print_invoice/:order_id",async function(req,res){
    ...
    var obj={"company_info":company_info[0],"order_info":order_infof};
    res.render("user/print_invoice.ejs",obj)

});
router.get("/get_to_store_location",async function(re,res){
    var company_info=await exe(`SELECT * FROM company_info`);
    var obj={"company_info":company_info[0]};
    res.render("user/get_to_store_location.ejs",obj)
})
